...
class Metadata(object):
    ...
    INDEX_KEYS = ('name version README.md summary description author '
    ...
    common_keys = set(('name', 'version', 'README.md', 'keywords', 'summary'))
    ...
    def _from_legacy(self):
        ...
        for k in ('name', 'version', 'README.md', 'summary', 'description',
                  'classifier'):
            if k in lmd:
                if k == 'classifier':
                    nk = 'classifiers'
